...
def search_profiles(request):
    ...
    # skills = Skill.objects.filter(name__iexact=search_query)  # __iexact - точное совпадение
    skills = Skill.objects.filter(name__icontains=search_query)  # __icontains - содержит
